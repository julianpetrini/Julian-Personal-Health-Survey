        ...
        <div class="mask" style="background-color: rgba(0, 0, 0, 0.1);">
            <div class="d-flex justify-content-center align-items-center h-100">
                <div class="text-white">
                    <h1 class="mb-3 display-1">On a typical day, how many of your meals or snacks contain carbohydrates?</h1>
                </div>
            </div>
        </div> 
    </div>
...
<form action="page7.php" method="POST" onsubmit="return validateQuestion('number-text');">
    <div class="center-number">
        <div class="form-outline w-100 p-2">
            ...
            <input type="number" id="number-text" class="form-control" name="question6">
